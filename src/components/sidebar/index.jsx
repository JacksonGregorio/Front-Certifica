...
export default function SideBar() {
  ...
  return (
    <>
    <div className="fixed top-1 left-0 p-2 bg-gray-800 text-white rounded-full shadow">
    <button onClick={() => setIsOpen(!isOpen)} className="items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        {isOpen}
        <svg
      ...
      <aside
        id="default-sidebar"
        className="fixed top-0 left-0 z-40 w-full h-full sm:w-64 sm:h-screen bg-gray-800"
        aria-label="Sidebar"
      >
