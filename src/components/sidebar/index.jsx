...
export default function SideBar() {
  ...
  return (
    <>
    <div class="fixed top-1 left-0 p-4 bg-gray-800 text-white rounded-full shadow">
    <button onClick={() => setIsOpen(!isOpen)} class="items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        {isOpen ? '' : ''}
        <svg
